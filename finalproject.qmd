...
## Residual Plots
```{r prediction-gross2, message = F, warning = F}
 
```

## Hypothesis Test 1:
Aim 1: Budget does NOT have an effect on the success of the movies.
Null hypothesis: 
Alternative hypothesis: 

```{r budget-gross-hypothesis, message = F, warning = F}
 
```

## Hypothesis Test 2:
Aim 2: Genre has an effect on the success of the movies
Null hypothesis: 
Alternative hypothesis:
